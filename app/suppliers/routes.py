...
async def create_supplier_page(
...
async def supplier_ledger(
    ...
    summary = SupplierLedgerService.get_supplier_summary(
...
async def outstanding_report(
    ...
    suppliers = SupplierLedgerService.get_all_outstanding(
